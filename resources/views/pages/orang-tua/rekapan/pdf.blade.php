...
<body>
    ...
    <h5 class="font-weight-bold"  style="font-size: 16px;">Nama : {{ $item->user->nama }}<br>NISN : {{ $item->nisn }}</h5>
    <div class="table-responsive">
        <table class="table table-bordered" id="table">
            <thead>
                <tr class="text-center">
                    <th rowspan="2" style="vertical-align : middle; text-align:center;">Kelas & Semester</th>
                    <th style="vertical-align : middle; text-align:center;" colspan="28">Nilai</th>
                </tr>
                <tr class="text-center">
