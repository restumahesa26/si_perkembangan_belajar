...
<div class="row">
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold">Tambah Data Siswa</h5>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="status_keluarga" class="form-control @error('status_keluarga') is-invalid @enderror" id="status_keluarga" placeholder="Status Keluarga" value="{{ old('status_keluarga') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="anak_ke" class="form-control @error('anak_ke') is-invalid @enderror" id="anak_ke" placeholder="Anak Ke" value="{{ old('anak_ke') }}" required>
                                @error('anak_ke')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Nomor Handphone" value="{{ old('no_hp') }}">
                                @error('no_hp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="no_kk" class="form-control @error('no_kk') is-invalid @enderror" id="no_kk" placeholder="Nomor Kartu Keluarga" value="{{ old('no_kk') }}" required>
                                @error('no_kk')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <select name="orang_tua_id" id="orang_tua_id" class="orang_tua w-100" required>
                                    ...
                                    @foreach ($items as $orang_tua)
                                        <option value="{{ $orang_tua->id }}" @if (old('orang_tua_id') == $orang_tua->id)
                                            selected
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="sekolah_asal" class="form-control @error('sekolah_asal') is-invalid @enderror" id="sekolah_asal" placeholder="Sekolah Asal" value="{{ old('sekolah_asal') }}">
                                @error('sekolah_asal')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_sekolah_asal" class="form-control @error('alamat_sekolah_asal') is-invalid @enderror" id="alamat_sekolah_asal" placeholder="Alamat Sekolah Asal" value="{{ old('alamat_sekolah_asal') }}">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="minat_jurusan" class="form-control @error('minat_jurusan') is-invalid @enderror" id="minat_jurusan" placeholder="Minat Jurusan" value="{{ old('minat_jurusan') }}">
                                @error('minat_jurusan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="cita_cita" class="form-control @error('cita_cita') is-invalid @enderror" id="cita_cita" placeholder="Cita-Cita" value="{{ old('cita_cita') }}">
                                @error('cita_cita')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="target_prestasi" class="form-control @error('target_prestasi') is-invalid @enderror" id="target_prestasi" placeholder="Target Prestasi" value="{{ old('target_prestasi') }}">
