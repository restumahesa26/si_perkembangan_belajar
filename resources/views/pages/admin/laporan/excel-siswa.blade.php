        ...
        <table class="table table-bordered" id="table">
            <thead>
                <tr class="text-center">
                    ...
                    <th colspan="28" style="vertical-align : middle; text-align:center;">Nilai</th>
                </tr>
                <tr class="text-center">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <th style="vertical-align : middle; text-align:center;">{{ $item2->siswa->user->nama }} ({{ $item2->nisn }})</th>
