...
@section('title', 'Data Prestasi Akademik - Ubah')
...
<div class="row">
    <div class="col-lg-8 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold">Ubah Data Prestasi Akademik</h5>
                <form action="{{ route('prestasi-akademik.update', $item->id) }}" method="post" class="mt-3">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-start mt-3">
                        <a href="{{ route('prestasi-akademik.index') }}" class="btn btn-secondary me-2">Kembali</a>
