...
@section('title', 'Data Orang Tua - Ubah')
...
<div class="row">
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold">Ubah Data Orang Tua</h5>
                <form action="{{ route('data-orang-tua.update', $item->id) }}" method="post" class="mt-3">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-start mt-3">
                        <a href="{{ route('data-orang-tua.index') }}" class="btn btn-secondary me-2">Kembali</a>
